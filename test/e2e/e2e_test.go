...
import (
	...
	"github.com/orange-cloudavenue/kube-image-updater/test/utils"

	. "github.com/onsi/ginkgo/v2"
	. "github.com/onsi/gomega"
)

const namespace = "kube-image-updater-system"
...
var _ = Describe("controller", Ordered, func() {
	...
	Context("Operator", func() {
		It("should run successfully", func() {
			...
			projectimage := "example.com/kube-image-updater:v0.0.1"
