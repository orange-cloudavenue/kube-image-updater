...
func main() {
	...
	_, err = k.AdmissionController().CreateOrUpdateMutatingConfiguration(
		context.Background(),
		models.AdmissionControllerMutatingWebhookConfigurationName,
		admissionregistrationv1.ServiceReference{
			Name:      "mutator",
			Namespace: "kimup-operator",
			Path:      &models.AdmissionControllerWebhookPathMutateImageTag,
		},
